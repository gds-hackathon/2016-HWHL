...
#define kYellowColor                [UIColor colorWithRed:0.96 green:.63 blue:.23 alpha:1]
#define PURPLE_COLOR                [UIColor colorWithRed:.66 green: .40 blue: .69 alpha: 1]
#define THEME_COLOR                 [UIColor colorWithRed:.33 green: .75 blue: .29 alpha: 1]

#define VIP_COLOR                   [UIColor colorWithRed:1 green:.91 blue:0 alpha:1]
#define SUPER_VIP_COLOR             PURPLE_COLOR
...
#define kIsiOS7                     [UIDevice currentDevice].systemVersion.floatValue>=7
